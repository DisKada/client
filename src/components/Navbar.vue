...
export default {
  methods: {
    ...
    toProfile () {
      this.$router.push({ path: `/profile/${localStorage.getItem('userId')}` })
    },
    toListRoom () {
